                    ...
                    <form action="{{ route('billUpdate',$data->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="number" class="form-control" id="inputName" name="bill_code" title="يرجي ادخال رقم الفاتورة" value="{{$data->bill_code}}" required>
                                @error('bill_code')
                            ...
                            <div class="col">
                                ...
                                <select name="discount_rate_id" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    ...
                                    @foreach ($tax_rate as $info)
                                        <option {{$data->product_id == $info->id ? "selected" : ""}} value="{{ $info->id }}"> {{ $info->discount_rate }}</option>
                                    @endforeach
                                </select>
