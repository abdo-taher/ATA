...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					...
					<div class="main-dashboard-header-right">
						<div>
							<label class="tx-13">تصنيفك</label>
							<div class="main-star">
								<i class="typcn typcn-star active"></i> <i class="typcn typcn-star active"></i> <i class="typcn typcn-star active"></i> <i class="typcn typcn-star active"></i> <i class="typcn typcn-star"></i> <span>(14,873)</span>
							</div>
						</div>
						<div>
							<label class="tx-13">العمل علي الانترنت</label>
							<h5>563,275</h5>
						</div>
						<div>
							<label class="tx-13">العمل المكتبي</label>
							<h5>783,675</h5>
						</div>
					</div>
				</div>
						...
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">${{number_format(\App\Models\Admin\billModel::sum('total'),2) }}</h4>
											<p class="mb-0 tx-12 text-white op-7">اجمالي الفواتير  <span>{{\App\Models\Admin\billModel::count() }}</span></p>
										</div>
						...
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">${{number_format(\App\Models\Admin\billModel::where('status_id',2)->sum('total'),2) }}</h4>
											<p class="mb-0 tx-12 text-white op-7">اجمالي الفواتير  <span>{{\App\Models\Admin\billModel::where('status_id',2)->count() }}</span></p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">{{round(\App\Models\Admin\billModel::where('status_id',2)->count() / \App\Models\Admin\billModel::count() * 100  )}} %</span>
										</span>
									</div>
								</div>
							</div>
						...
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">${{number_format(\App\Models\Admin\billModel::where('status_id',1)->sum('total'),2) }}</h4>
											<p class="mb-0 tx-12 text-white op-7">اجمالي الفواتير  <span>{{\App\Models\Admin\billModel::where('status_id',1)->count() }}</span></p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">{{round(\App\Models\Admin\billModel::where('status_id',1)->count() / \App\Models\Admin\billModel::count() * 100)}} %</span>
										</span>
									</div>
								</div>
							</div>
						...
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">${{number_format(\App\Models\Admin\billModel::where('status_id',3)->sum('total'),2) }}</h4>
											<p class="mb-0 tx-12 text-white op-7">اجمالي الفواتير  <span>{{\App\Models\Admin\billModel::where('status_id',3)->count() }}</span></p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">{{round(\App\Models\Admin\billModel::where('status_id',3)->count() / \App\Models\Admin\billModel::count() * 100  )}} %</span>
										</span>
									</div>
								</div>
							</div>
				...
				<div class="row row-sm">
					<div class="col-md-12 col-lg-12 col-xl-7">
						<div class="card">
							<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
								...
								<p class="tx-12 text-muted mb-0">في هذا الشكل البياني نوضح حالات الفواتير حسب الشهر.</p>
							</div>
							<div class="card-body">
								<div class="total-revenue">
									<div>
									  <h4>{{\App\Models\Admin\billModel::where('status_id',1)->count() }}</h4>
									  <label><span class="bg-primary"></span>فواتير مدفوعة</label>
									</div>
									<div>
									  <h4>{{\App\Models\Admin\billModel::where('status_id',2)->count() }}</h4>
									  <label><span class="bg-danger"></span>فواتير غير مدفوعة</label>
									</div>
									<div>
									  <h4>{{\App\Models\Admin\billModel::where('status_id',3)->count() }}</h4>
									  <label><span class="bg-warning"></span>فواتير مدفوعة جزئيا</label>
									</div>
								  </div>
					...
					<div class="col-lg-12 col-xl-5">
						<div class="card card-dashboard-map-one">
							<label class="main-content-label">مناطق تواجد الفواتير</label>
							<span class="d-block mg-b-20 text-muted tx-12">شكل يبين نوزيع الفواتير واماكن تمركزها واكثر البلاد تعاملا معها</span>
							<div class="">
