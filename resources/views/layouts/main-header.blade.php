					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{asset('assets/img/admin/'.auth()->user()->username . "/" .auth()->user()->image)}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{asset('assets/img/admin/'.auth()->user()->username . "/" .auth()->user()->image)}}" class=""></div>
									...
									<a class="dropdown-item" href="{{route('exit')}}"><i class="bx bx-log-out"></i>تسجيل الخروج</a>
								</div>
							</div>
