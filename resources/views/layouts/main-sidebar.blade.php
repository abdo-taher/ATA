    ...
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround" src="{{asset('assets/img/admin/'.auth()->user()->username . "/" .auth()->user()->image)}}"><span class="avatar-status profile-status bg-green"></span>
                </div>
                <div class="user-info">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    @can('قائمة الفواتير')
                    <li><a class="slide-item" href="{{route('billIndex')}}">قائمة الفواتير</a></li>
                    @endcan
                    @can('الفواتير المدفوعة')
                    <li><a class="slide-item" href="{{route('billPaid','fullPaid')}}">الفواتير المدفوعة</a></li>
                    @endcan
                    @can('الفواتير الغير مدفوعة')
                    <li><a class="slide-item" href="{{route('billPaid','NonPaid')}}">الفواتير الغير مدفوعة</a></li>
                    @endcan
                    @can('الفواتير المدفوعة جزئيا')
                    <li><a class="slide-item" href="{{route('billPaid','partiallyPaid')}}">الفواتير المدفوعة جزئيا</a></li>
                    @endcan
                </ul>
            </li>
            @endcan
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    @can('تقرير الفواتير')
                    <li><a class="slide-item" href="{{route('billReports')}}">تقارير الفواتير</a></li>
                    @endcan
                    @can('تقرير العملاء')
                    <li><a class="slide-item" href="{{route('customerReports')}}">تقارير العملاء</a></li>
                    @endcan
                </ul>
            </li>
            @endcan
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    @can('الاقسام')
                    <li><a class="slide-item" href="{{route('sectionIndex')}}">الاقسام</a></li>
                    @endcan
                    @can('المنتجات')

                    <li><a class="slide-item" href="{{route('productIndex')}}">المنتجات</a></li>
                    @endcan
                </ul>
            </li>
            @endcan
