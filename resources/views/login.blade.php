...
@section('title')
    تسجيل الدخول - ATA نظام تخزين ومبيعات
@stop
                                ...
                                <div class="card-sigin">
                                    ...
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            ...
                                            <form action="{{route('loginCheckup')}}" method="post" >
                                                    @csrf
                                                ...
                                                <input type="submit" class="btn btn-main-primary btn-block" value="{{ __('تسجيل الدخول') }}">
                                            </form>
                                        </div>
                                    </div>
                                </div>
